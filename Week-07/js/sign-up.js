...
nameInput.addEventListener("blur", function () {
  ...
  for (var i = 0; i < nameInput.value.length; i++) {
    ...
    if ((char < 65 || char > 90) && (char < 97 || char > 122)) {
      document.getElementById("name-error").innerText =
        "Letters only and must be more than 3 letters";
      addClassRed(nameInput);
      validName = false;
...
lastNameInput.addEventListener("blur", function () {
  ...
  if (lastNameInput.value === "") {
    document.getElementById("last-name-error").innerText =
      "Must complete the field with your name";
  ...
  for (var i = 0; i < lastNameInput.value.length; i++) {
    ...
    if ((char < 65 || char > 90) && (char < 97 || char > 122)) {
      ...
      document.getElementById("last-name-error").innerText =
        "Must have al least three letters";
      addClassRed(lastNameInput);
      validLastName = false;
    }
  }
...
dniInput.addEventListener("blur", function () {
  ...
  if (dniInput.value === "") {
    document.getElementById("dni-error").innerText =
      "Must complete the field with your DNI";
...
birthdateInput.addEventListener("blur", function () {
  ...
  if (birthdateInput.value === "") {
    document.getElementById("birthdate-error").innerText =
      "Must complete the field with your Birthdate";
    addClassRed(birthdateInput);
    validDob = false;
  } else {
    if (birthdateInput.value.substring(0, 4) > 2017) {
      document.getElementById("birthdate-error").innerText =
        "The gym can only enter over 6 years";
      addClassRed(birthdateInput);
      validDob = false;
    } else if (birthdateInput.value.substring(0, 4) < 1933) {
      document.getElementById("birthdate-error").innerText =
        "Are you sure you are over 90 years old?";
      addClassRed(birthdateInput);
      validDob = false;
    } else {
...
phoneInput.addEventListener("blur", function () {
  ...
  if (phoneInput.value === "") {
    document.getElementById("phone-error").innerText =
      "Must complete the field with your Phone Number";
...
addressInput.addEventListener("blur", function () {
  ...
  if (addressInput.value === "") {
    document.getElementById("address-error").innerText =
      "Must complete the field with your Adrress";
...
cityInput.addEventListener("blur", function () {
  ...
  if (cityInput.value === "") {
    document.getElementById("city-error").innerText =
      "Must complete the field with your city";
...
postalCodeInput.addEventListener("blur", function () {
  ...
  if (postalCodeInput.value === "") {
    document.getElementById("postal-code-error").innerText =
      "Must complete the field with your Postal Number";
    ...
    if (
      ...
      document.getElementById("postal-code-error").innerText =
        "Must be between 4 and 5 numbers";
      addClassRed(postalCodeInput);
      validPC = false;
    }
  }
